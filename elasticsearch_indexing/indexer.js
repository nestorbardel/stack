...
function IndexMongodbData (esIndexName,esIndexType,collectionName)
{
    if (config.mongodb.username!="" && config.mongodb.password!="")
        var url = config.mongodb.mongodb.url+config.mongodb.username+":"+config.password+"@"+config.mongodb.local_server_ip+":"+config.mongodb.port;
    else
        var url = config.mongodb.url+config.mongodb.local_server_ip+":"+config.mongodb.port;
    console.log(url);    
